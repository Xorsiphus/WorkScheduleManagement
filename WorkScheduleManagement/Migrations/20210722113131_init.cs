        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "text", nullable: true),
                    NumberOfWorkingHours = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_UserPositions_PositionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Requests_AspNetUsers_DayOffInsteadOverworkingRequest_Replac~",
                        column: x => x.DayOffInsteadOverworkingRequest_ReplacerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Requests_AspNetUsers_DayOffInsteadVacationRequest_ReplacerId",
                        column: x => x.DayOffInsteadVacationRequest_ReplacerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Requests_AspNetUsers_ReplacerId",
                        column: x => x.ReplacerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Requests_AspNetUsers_VacationRequest_ReplacerId",
                        column: x => x.VacationRequest_ReplacerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DayOffInsteadOverworking", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DayOffInsteadOverworking_Requests_RequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DayOffInsteadVacation", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DayOffInsteadVacation_Requests_RequestId",
                        column: x => x.RequestId,
                        principalTable: "Requests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HolidayList_Requests_RequestId",
                        column: x => x.RequestId,
                        principalTable: "Requests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DayOffInsteadOverworking_RequestId",
                table: "DayOffInsteadOverworking",
                column: "RequestId");

            migrationBuilder.CreateIndex(
                name: "IX_DayOffInsteadVacation_RequestId",
                table: "DayOffInsteadVacation",
                column: "RequestId");

            migrationBuilder.CreateIndex(
                name: "IX_HolidayList_RequestId",
                table: "HolidayList",
                column: "RequestId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Requests_DayOffInsteadOverworkingRequest_ReplacerId",
                table: "Requests",
                column: "DayOffInsteadOverworkingRequest_ReplacerId");

            migrationBuilder.CreateIndex(
                name: "IX_Requests_DayOffInsteadVacationRequest_ReplacerId",
                table: "Requests",
                column: "DayOffInsteadVacationRequest_ReplacerId");

            migrationBuilder.CreateIndex(
                name: "IX_Requests_ReplacerId",
                table: "Requests",
                column: "ReplacerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Requests_VacationRequest_ReplacerId",
                table: "Requests",
                column: "VacationRequest_ReplacerId");
